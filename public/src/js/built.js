...
define("plupload/plupload", (function (global) {
    return function () {
        var ret, fn;
...
define('app',['jquery', 'underscore', 'backbone', 'utils/utils', 'app/models/song-model', 'app/views/song-view', 'helper', 'bootstrap'],

function($, _, Backbone, utils, SongModel, SongView, helper) {
