...
define("plupload/zh_CN", function(){});
...
define('app/views/song-view',['jquery', 'backbone', 'text!app/templates/song-template.html', 'helper', 'utils/utils', 'app/models/resource-model', 'app/views/resource-view', 'plupload/plupload', 'plupload/zh_CN', 'utils/config'],
...
define('app',['jquery', 'underscore', 'backbone', 'utils/utils', 'app/models/song-model', 'app/views/song-view', 'test', 'bootstrap'],

function($, _, Backbone, utils, SongModel, SongView, tt) {
