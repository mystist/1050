...
define("helper", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.helper;
    };
}(this)));
...
define('app/views/resource-view',['jquery', 'backbone', 'text!app/templates/resource-template.html', 'app/models/resource-model'],
...
define('../app',['jquery', 'backbone', 'utils/utils', 'app/models/song-model', 'app/views/song-view', 'bootstrap'],
