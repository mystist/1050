...
;(function(factory) {
  ...
  if (typeof module === 'function') {
    ...
    define('nprogress/nprogress',['jquery'], function($) {
      return factory($);
    });
  } else {
...
define('utils/utils',['jquery', 'nprogress/nprogress', 'backbone'], function($, NProgress, Backbone) {
...
define('app/models/song-model',['backbone'], function(Backbone) {
...
define('app/models/resource-model',['backbone', 'backbone.localstorage'], function(Backbone) {
...
define('text!app/templates/resource-template.html',[],function () { return '<div>\r\n\r\n<script id="ResourceTemplate" type="text/template">\r\n\r\n<% var m = model.toJSON(); %>\r\n<td><%= m.file_name %></td>\r\n<td>\r\n  <% if(m.file_type == "song") { %>\r\n    <%= (m.file_size/1000000).toFixed(2) %>MB\r\n  <% } %>\r\n  <% if(m.file_type == "pic") { %>\r\n    <%= (m.file_size/1000).toFixed(2) %>KB\r\n  <% } %>\r\n</td>\r\n<td><%= helper.formatDateTime(m.uploaded_time, "second") %></td>\r\n<td tag="stars"></td>\r\n<td>\r\n  <div class="btn-group" tag="resource_star_container">\r\n  </div>\r\n</td>\r\n<td resource_id="<%= m.id %>" >\r\n  <% if(m.file_type == "song") { %>\r\n    <button type="button" class="btn btn-success btn-xs" tag="play">播放</button>\r\n  <% } %>\r\n  <% if(m.file_type == "pic") { %>\r\n    <a class="btn btn-warning btn-xs" href="<%= config_1050.bucketUrl + encodeURIComponent(m.file_name) %>" target="_blank" >查看</a>\r\n  <% } %>\r\n  <a class="btn btn-primary btn-xs" href="<%= config_1050.bucketUrl + encodeURIComponent(m.file_name) + "?download/" + encodeURIComponent(m.file_name) %>" target="_blank">下载</a>\r\n  <button type="button" class="btn btn-default btn-xs" tag="delete_resource" data-toggle="tooltip" title="双击">删除</button>\r\n</td>\r\n\r\n</script>\r\n\r\n<script id="ResourceStarTemplate" type="text/template">\r\n  <% var m = model?model.toJSON():null; %>\r\n  <button type="button" class="btn btn-xs <%= (m&&m.current==1)?"btn-info":"btn-default" %>" tag="up">顶</button>\r\n  <button type="button" class="btn btn-xs <%= (m&&m.current==-1)?"btn-info":"btn-default" %>" tag="down">踩</button>\r\n</script>\r\n\r\n</div>';});

define('app/views/resource-view',['jquery', 'backbone', 'text!app/templates/resource-template.html', 'app/models/resource-model', 'helper'],
...
define('app/views/song-view',['jquery', 'backbone', 'text!app/templates/song-template.html', 'helper', 'utils/utils', 'plupload/zh_CN', 'app/models/resource-model', 'app/views/resource-view', 'utils/config'],
...
define("test", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.tt;
    };
}(this)));
...
define('app',['jquery', 'backbone', 'utils/utils', 'app/models/song-model', 'app/views/song-view', 'test', 'bootstrap'],

function($, Backbone, utils, SongModel, SongView, tt) {
